...
const Orders = () => {
  ...
  const { myOrders, totalOrderCount } = useSelector((state) => state.order);
                ...
                <tr key={i} className="bg-white border-b">
                  ...
                  <td className="px-6 py-4">
                    ...
                    {o.payment_status !== "paid" ? (
                      ...
                      <span className="bg-blue-100 text-green-800 text-sm font-normal mr-2 px-2.5 py-[1px] rounded whitespace-nowrap">
                        Success
                      </span>
                    )}
                  </td>
