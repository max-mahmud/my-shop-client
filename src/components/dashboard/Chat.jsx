  ...
  return (
    <div className="bg-white p-3 rounded-md">
      <div className="w-full flex relative">
        <div
          className={`w-[230px] md-lg:absolute transition-all md-lg:h-full bg-white z-40 md-lg:top-0  ${
            open ? "md-lg:-left-[300px]" : "md-lg:-left-[0px]"
          }`}
        >
          ...
          {currentFd ? (
            <div className="w-full h-full">
              <div className="flex justify-between gap-3 items-center text-slate-600 text-xl h-[50px]">
                ...
                <div onClick={() => setOpen(!open)} className="shadow-sm border-2 p-1 hidden md-lg:block ">
                  <FaList />
                </div>
              </div>
                      ...
                      return (
                        ...
                        >
                          <img
                            ...
                            alt=""
                          />
                          <div className="p-2 bg-zinc-600/70 text-white rounded-md">
                            <span>{m.message}</span>
                          </div>
                        </div>
                      );
            ...
            <div onClick={()=>setOpen(false)} className="w-full h-[400px] flex justify-center items-center text-lg gont-bold text-slate-600">
