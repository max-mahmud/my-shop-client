            ...
            <div>
              <div className="flex justify-center items-center gap-10">
                ...
                <div className="flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]">
                  <img src="https://my-shop-client-nine.vercel.app/images/language.png" alt="" />
                  <span>
          ...
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className="md-lg:w-full w-3/12 md-lg:pt-4">
              <div className="flex justify-between items-center">
                <Link to="/">
                  <img src="https://my-shop-client-nine.vercel.app/images/logo.png" alt="logo" />
                </Link>
                <div
          ...
          <div className="flex justify-start flex-col gap-6">
            ...
            <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
              ...
              <div className="flex justify-end flex-col gap-1">
                <h2 className="text-sm font-medium text-slate-700">+88034515548</h2>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              ...
              <div
                ...
                } overflow-hidden transition-all md-lg:relative duration-400 absolute z-[99999] bg-white w-full border-x`}
              >
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
                ...
                <div className="flex border h-[50px] items-center relative gap-5">
                  <div className="relative after:absolute after:h-[25px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden">
                    <select
                      ...
                      className="w-[150px] text-slate-600 font-semibold bg-transparent px-2 h-full outline-0 border-none py-3"
                      name=""
                      id=""
                    >
                      <option value="">Select category</option>
                      {categorys.map((c, i) => (
                        <option className="text-slate-300 bg-gray-600" key={i} value={c.name}>
                          {c.name}
                        </option>
                      ))}
                    </select>
              ...
              <div className="w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0">
                <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
                  ...
                  <div className="flex justify-end flex-col gap-1">
                    <h2 className="text-md font-medium text-slate-700">+8803242145455</h2>
