...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#F3F6Fa]">
        ...
        <div className="w-3/12 lg:w-4/12 sm:w-full">
          <div className="flex flex-col gap-3">
            <img
              ...
              src="https://my-shop-client-nine.vercel.app/images/logo.png"
              alt="logo"
            />
            <ul className="flex flex-col gap-2 text-slate-600">
              <li>Address : Rajshahi, Chapai</li>
      ...
      <div className="hidden shadow fixed md-lg:block w-[50px] bottom-3 h-[110px] right-2 bg-white rounded-full p-2">
