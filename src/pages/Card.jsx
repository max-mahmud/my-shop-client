...
const Card = () => {
  ...
  const { card_products, successMessage, outofstock_products, buy_product_item, price, shipping_fee } =
                          ...
                          <div className="w-full flex flex-wrap" key={i}>
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                <div className="flex bg-slate-200 h-[30px] justify-center items-center">
                                  <div
                                  ...
                                  <div className="px-3 text-xl">{pt.quantity}</div>
                                  <div
                                ...
                                <button
                                  ...
                                  className="px-5 py-[3px] bg-red-500 text-white hover:bg-red-600"
                                >
                                  Delete
                                </button>
                              </div>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="bg-white p-4">
                          {outofstock_products.map((p, i) => (
                            <div className="w-full flex flex-wrap" key={i + 1}>
                              <div className="flex sm:w-full gap-2 w-7/12">
                                <div className="flex gap-2 justify-start items-center">
                                  <img
                                    className="w-[80px] h-[80px]"
                              ...
                              <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                ...
                                <div className="flex gap-2 flex-col">
                                  <div className="flex bg-slate-200 h-[30px] justify-center items-center text-xl">
                                    ...
                                    <div
                                      onClick={() => inc(p.quantity, p.products[0].stock, p._id)}
                                      className="px-3 cursor-pointer"
                                    >
                                      +
                                    </div>
