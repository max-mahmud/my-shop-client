...
const Details = () => {
  ...
  return (
    <div>
      <Headers />
      <div className='bg-[url("https://my-shop-client-nine.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                    ...
                    {product.images.map((img, i) => {
                      return (
                        <div key={i} onClick={() => setImage(img)}>
                          <img
                            className="h-[120px] w-[126px] cursor-pointer ml-3 px-1 "
                            src={img}
                            alt="img"
                          />
                        </div>
              ...
              <div className="flex gap-3 pb-10 border-b">
                {product.stock ? (
                  <>
                    <div className="flex bg-slate-200 h-[50px] justify-center items-center ">
                      ...
                      <div className="px-5 text-xl">{quantity}</div>
                    ...
                    <div>
                      <button
                        onClick={add_card}
                        className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg bg-purple-500 hover:shadow-purple-500/40 text-white"
                      >
                        Add To Card
                      </button>
                    </div>
                ...
                <div>
                  <div
                    ...
                    className="h-[50px] text-2xl w-[50px] flex justify-center items-center cursor-pointer hover:shadow-lg hover:shadow-cyan-500/40 bg-cyan-500 text-white"
                  >
                    <AiFillHeart />
                  </div>
                </div>
